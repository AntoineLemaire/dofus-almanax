    ...
    <head>
        ...
        <style type="text/css">
            *{
            ...
            .offering {
                background-image:url('./ui/img/<?php echo $lang; ?>_bg_small.jpg');
                width: 433px;
                height: 73px;
            }
    ...
    <body>
        ...
        <ul id="carousel" class="jcarousel-skin-tango">
            ...
            for ($i = 0; $i <= 7; ++$i) {
                ...
                <li class="offering">
                    <div>
                        <div style="margin-right:5px;float:right;" id="div1">
                            <font color=black><b>
                                <?php if ($i != 0) {
                    ?>
                    ...
                    ?>
                        ...
                        <div style="margin-left:10px;float:left;width: 205px" id="div4"> 
                            <table BORDER=0>
                                <tr>
                                    <td>
                                        <?php
                                    ...
                                    <td style="width:140px;">
                                        <font color=white size=2><b>
                                            <?php echo trim($offrande->offering)?>
                                        </b></font>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <div style="margin:0;padding:0;width:150px;height: 18px;margin-top: 25px;margin-right: -8px;float:right;">
