    ...
    <head>
        ...
        <style type="text/css">
            *{
            ...
            .offering {
                background-image:url('./ui/img/forumcmb/<?php echo $lang; ?>_bg.png');
                width: 451px;
                height: 236px;
            }
                    ...
                    <div>
                        <div style="margin-left:268px" id="div1">
                            <font color=black><b>
                                <?php if ($i != 0) {
                    ?>
                                    <a class="carousel-prev" href="#" target="Contenu"><img src="ui/img/forumcmb/fleche_gauche.png" /></a>
                                <?php 
                } else {
                    ?>
                                ...
                                <?php if ($i != 8) {
                                    ?>
                                    <a class="carousel-next" href="#" target="Contenu"><img src="ui/img/forumcmb/fleche_droite.png" /></a>
                                <?php 
                                } ?>
                            </b></font>
                        </div>
